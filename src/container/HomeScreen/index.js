...
<AchievementComponent 
      ...
      <View style={styles.exerciseContainer}>
        <SubHeading subheading={'Exercise picked for you'} colors={colors.gradientColor2} />

        <TextComponent text={'View All  >'} fontsize={fontSizes.small} fontfamily={fontFamily.light} textColor={colors.white}/>
